...
clean:
	...
	rm -rf search/breadthfirstsearch/__pycache__ # remove compiled python directory
	rm -rf test/breadthfirstsearch/__pycache__ # remove compiled python directory
	rm -rf search/depthfirstsearch/__pycache__ # remove compiled python directory
	rm -rf test/depthfirstsearch/__pycache__ # remove compiled python directory
