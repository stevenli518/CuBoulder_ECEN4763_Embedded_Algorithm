...
In this assignment you will create the RSA algorithm from sratch. Please follow the guidelines located in the README.md.

## Goal

The main goal for this assignment is to learn all of the smaller algorithms that are used to create the RSA algorithm and how to put them together.
