...
In this assignment you will create your own hybrid sort algorithm. Specifically, you will be implementing TimSort. Please follow the guidelines located in the README.md.

## Goal

The main goal for this assignment is to learn how to combine together different implementations and improve results.
